...
images = convert_from_path('D:\script\python\PDF_tools\document-page4.pdf')

import tempfile

with tempfile.TemporaryDirectory() as path:
    images_from_path = convert_from_path('D:\script\python\PDF_tools\document-page4.pdf', output_folder=path)
    # Do something here

from pdf2image import convert_from_path

pages = convert_from_path('document-page4.pdf', 500)
...
save_dir = 'D:\script\python\PDF_tools'
